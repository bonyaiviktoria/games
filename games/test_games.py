...
def test_default():
    assert magic_finder("I have {'Number: '} {'Animal: '} at home") == [
        "Number: ",
        "Animal: ",
    ]
    ...
    assert (
        battle({"name": "rock", "sign": "✊"}, {"name": "paper", "sign": "✋"})
        == "Sorry, I won this time ✨ Another try?"
    )
    assert (
        battle({"name": "scissors", "sign": "✌"}, {"name": "scissors", "sign": "✌"})
        == "It's a tie! 🌸"
    )
